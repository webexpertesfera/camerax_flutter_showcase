...
package com.android.example.cameraxbasic.photoeditor;
...
public class CropImageActivity extends AppCompatActivity
  ...
  protected Uri getOutputUri() {
    ...
    if (outputUri == null || outputUri.equals(Uri.EMPTY)) {
      try {
        outputUri = Uri.fromFile(File.createTempFile("cropped", ".jpg", MainActivity.Companion.getOutputDirectory(this)));
      } catch (IOException e) {
  ...
  protected void setResult(Uri uri, Exception error, int sampleSize) {
    ...
    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
      sendBroadcast(
             new  Intent(android.hardware.Camera.ACTION_NEW_PICTURE, uri)
      );
    }
